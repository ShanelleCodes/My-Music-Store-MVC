...
namespace  MusicStore.Areas.Identity.Pages.Account.Manage
{
    /// <summary>
    ...
    public static class ManageNavPages
    {
        ...
        ////public static string StreetAddressNavClass(ViewContext viewContext) => PageNavClass(viewContext, StreetAddress);
        ////public static string CityNavClass(ViewContext viewContext) => PageNavClass(viewContext, City);
        ////public static string StateProvinceNavClass(ViewContext viewContext) => PageNavClass(viewContext, StateProvince);
        ////public static string PostalCodeNavClass(ViewContext viewContext) => PageNavClass(viewContext, PostalCode);
